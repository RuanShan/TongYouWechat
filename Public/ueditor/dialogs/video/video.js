...
(function(){
    ...
    function initSlide(){
        ...
        (function(){
            ...
            if(img && img.className){
                ...
                if(hasUploadClass) {
                    isModifyUploadSlide = true;
                }
            }
            createPreviewSlide(url);
        })();
    }
    ...
    function insertSingle(){
        ...
        editor.execCommand('insertvideo', {
            ...
            height: height.value,
            align: align
        }, isModifyUploadSlide ? 'upload':null);
    }
     ...
     * @param url
     */
    function createPreviewSlide(url){
        if ( !url )return;

        var conUrl = convert_url(url);

        $G("preview").innerHTML = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>'+
        '<embed class="previewSlide" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
            ' src="' + conUrl + '"' +
            ' width="' + 420  + '"' +
            ' height="' + 280  + '"' +
    ...
    function insertUpload(){
        ...
        for(var key in uploadSlideList) {
            var file = uploadSlideList[key];
            videoObjs.push({
