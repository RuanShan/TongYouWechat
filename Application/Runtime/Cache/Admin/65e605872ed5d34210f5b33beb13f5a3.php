            ...
            <ul class="main-navigation-menu">
              ...
              <li class="<?php if(($_SESSION['menu']['module']) == "Slide"): ?>active<?php endif; ?>">
                ...
                <i class="clip-user-5"></i>
                  <span class="title"> <a href="<?php echo U('User/index',array('id'=>1));?>">客户</a> </span><span class="selected"></span>
                </span>
              </li>
              <li class="<?php if(($_SESSION['menu']['module']) == "Slide"): ?>active<?php endif; ?>">
                <span class="column_item">
                <i class="clip-user-5"></i>
                  <span class="title"> <a href="<?php echo U('User/index',array('id'=>2));?>">工程师</a> </span><span class="selected"></span>
                </span>
              </li>
              <li>
                <span class="column_item">
