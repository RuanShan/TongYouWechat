						...
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form role="form" method="post" action="<?php echo U('Config/update');?>" class="form-horizontal" enctype="multipart/form-data">
										<div class="form-group">
											<label class="col-sm-2 control-label">
												网站名称
											</label>
											<div class="col-sm-4">
												<input placeholder="请输入网站名称" name="name" value="<?php echo ($data["name"]); ?>" class="form-control" type="text">
											</div>
										</div>
                    <div class="form-group">
											<label class="col-sm-2 control-label">
											...
											<div class="col-sm-4">
												<input placeholder="请输入网站推广关键词" name="keywords" value="<?php echo ($data["keywords"]); ?>" class="form-control" type="text">
											</div>
										</div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">
                      ...
                      <div class="col-sm-4">
                      	<textarea placeholder="请输入网站推广描述" name="description" class="form-control"><?php echo ($data["description"]); ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-2 col-sm-offset-2">
                        ...
                        <button class="btn btn-blue next-step btn-block">
                          修改全局设置 <i class="fa fa-arrow-circle-right"></i>
                        </button>
                      </div>
                    </div>
									</form>
